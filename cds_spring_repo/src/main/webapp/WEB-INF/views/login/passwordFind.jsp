...
<body>
    <!-- 비밀번호 찾기 화면 -->
    <div class="container" id="pwFindScreen">
        <h1>비밀번호 찾기</h1>
        ...
        <button class="btn" onclick="showPwResult()">비밀번호 찾기</button>
    </div>

    <!-- 찾기 결과 화면 -->
    <div class="container" id="pwFindResultScreen" style="display:none;">
        <h2>비밀번호 찾기 결과</h2>
        ...
        <div class="divider"></div>
        <div class="btn-group">
            <button class="btn-small" onclick="location.href='login.jsp'">로그인</button>
            <button class="btn-small primary" onclick="location.href='passwordChange.jsp'">비밀번호 변경</button>
        </div>
    </div>
