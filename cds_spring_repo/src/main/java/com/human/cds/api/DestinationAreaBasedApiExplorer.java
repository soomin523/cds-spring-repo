...
public class DestinationAreaBasedApiExplorer {
    public static <T extends Object> T getApiJsonData( String serviceKey, String srcUrl, String numOfRows, String pageNo,
        ...
        urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode(numOfRows, "UTF-8")); /*어플명*/
        urlBuilder.append("&" + URLEncoder.encode("pageNo","UTF-8") + "=" + URLEncoder.encode(pageNo, "UTF-8")); /*관광타입(축제공연행사는 15)*/
